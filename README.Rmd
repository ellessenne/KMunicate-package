...
This follows from an issue with the {survival} package, see [here](https://github.com/ellessenne/KMunicate-package/issues/6) and [here](https://github.com/therneau/survival/issues/119) for more details.
